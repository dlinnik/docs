...
<details>
  ...
  <details>
    ...
    <ul>
      ...
      <li>Теперь статьи связанные с новым функционалом Databird будут помечаться тэгом 🆕</li>
      <li>Добавлен новый раздел документации "Работа через представление каталога"</li>
      <li>Добавлены 5 новых статей в раздел "Работа через представление каталога": Инструменты каталога, Инструмент "Заполнить вкладку", Инструмент "Заполнить атрибут", Инструмент "Привязка категорий", Инструмент "Привязка полей"</li>
      <li>Удалена статься "Выгрузка ассортимента в МегаМаркет", тк DataBird перешел на выгрузку карточек на ММ по API</li>
    </ul>
  </details>
</details>
...
### Работа через представление каталога
