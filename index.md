...
<details>
  ...
  <details>
    ...
    <ul>
      ...
      <li>Теперь статьи связанные с новыми инструментами Databird будут помечаться символом 🆕</li>
      <li>Добавлен новый раздел документации "Работа через представление каталога"</li>
      <li>Добавлены 5 новых статей в раздел "Работа через представление каталога": Инструменты каталога, Инструмент "Заполнить вкладку"</li>
    </ul>
  </details>
</details>
