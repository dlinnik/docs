...
<details>
  ...
  <details>
   <summary>Обновление от 15.06.2026</summary>
    <ul>
      <li>Раздел "Работа через представление каталога" переименован в "Инструменты по обогащению товаров данными".</li>
      <li>В раздел «Инструменты по обогащению товаров данными» добавлены 2 новые статьи: 
        <a href="/chto-takoe-generatsia-dannih/">Что такое история генераций?</a></li>
