 ...
 <details>
  <summary>👁️‍🗨️ История последних обновлений документации</summary>
   <details>
     ...
     * В документацию добавлен технический раздел "История последних обновлений документации"

     * Теперь статьи связанные с новыми инструментами Databird будут помечаться символом 🆕
     
     * Добавлен новый раздел документации "Работа через представление каталога"
     
     * Добавлены 5 новых статей в раздел "Работа через представление каталога": Инструменты каталога, Интрумент "Заполнить вкладку", Интрумент "Заполнить атрибут, Интрумент "Привязка категорий", Интрумент "Привязка полей"
   </details>
</details>
