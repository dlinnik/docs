...
<details>
  ...
  <details>
    ...
    <ul>
      <li>В документацию добавлен технический раздел «История последних обновлений документации».</li>
      <li>Теперь статьи, связанные с новым функционалом DataBird, будут помечаться тегом 🆕.</li>
      <li>Добавлен новый раздел документации «Работа через представление каталога».</li>
      <li>В раздел «Работа через представление каталога» добавлено 5 новых статей: 
        <a href="/chto-takoe-instumenti/">Инструменты каталога</a>, 
        <a href="/instrument-zapolnit-vkladky/">Инструмент "Заполнить вкладку"</a>, 
        <a href="/instrument-zapolnit-atribut/">Инструмент "Заполнить атрибут"</a>, 
  ...
  <details>
   <summary>Обновление от 15.06.2026</summary>
    <ul>
      <li>Раздел "Работа через представление каталога" переименован в "Инструменты по обогащению товаров данными". Теперь в общем списке он располагается выше, под разделом "Источники данных о товарах".</li>
      <li>В раздел «Инструменты по обогащению товаров данными» добавлены 2 новые статьи: 
        <a href="/chto-takoe-generatsia-dannih/">Что такое история генераций?</a>,
        <a href="/instrument-infografica/">Интрумент "Генерация инфографики"</a></li>
...
🆕 [Настройка вкладки источника](/nastroyki-vkladki/)
...
### Инструменты по обогащению товаров данными
...
🆕 [Интрумент "Генерация инфографики"](/instrument-infografica/)
...
[Включить отображение фото в каталоге товаров, если их не видно](/vklyuchit-otobrazhenie-foto-v-kataloge-tovarov-esli/)
