...
[Что такое представление каталога?] 

[Что такое вкладка источника?]

[Что такое инструменты?](/chto-takoe-instumenti/)

[Интрумент "Заполнить вкладку"]

[Интрумент "Заполнить атрибут"]

[Интрумент "Привязка категорий"]

[Интрумент "Привязка полей"]
